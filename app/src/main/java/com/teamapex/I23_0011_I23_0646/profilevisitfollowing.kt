...
class profilevisitfollowing : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            Log.e("ProfileVisitFollowing", "Error initializing views: ${e.message}")
        ...
        try {
            ...
            Log.e("ProfileVisitFollowing", "Optional views not found: ${e.message}")
        }
    ...
    private fun setupClickListeners() {
        try {
            ...
            Log.e("ProfileVisitFollowing", "Error setting up listeners: ${e.message}")
        }
    }
        ...
        val request = StringRequest(
            ...
            { response ->
                try {
                    ...
                    Log.e("ProfileVisitFollowing", "Error parsing response: ${e.message}")
                    Toast.makeText(this, "Error loading profile", Toast.LENGTH_SHORT).show()
                }
            },
            { error ->
                Log.e("ProfileVisitFollowing", "Network error: ${error.message}")
        ...
        val request = StringRequest(
            ...
            { response ->
                try {
                    ...
                    Log.e("ProfileVisitFollowing", "Error loading pic: ${e.message}")
                }
            },
            { error ->
                Log.e("ProfileVisitFollowing", "Network error: ${error.message}")
        ...
        val request = StringRequest(
            ...
            { response ->
                try {
                    ...
                    Log.e("ProfileVisitFollowing", "Error: ${e.message}")
                    postsCount.text = "0"
                }
            },
            { error ->
    ...
    private fun showUnfollowDialog() {
        try {
            ...
            builder.setMessage("Are you sure you want to unfollow ${usernameText.text}?")

            builder.setPositiveButton("Unfollow") { dialog, _ ->
                unfollowUser()
                dialog.dismiss()
            }
            ...
            Log.e("ProfileVisitFollowing", "Error showing dialog: ${e.message}")
        }
    }
